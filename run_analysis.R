...
## Download the Data from file url on the internet
...
## Read files in folder ‘UCI HAR Dataset’  and create data tables.

filesPath <- paste(getwd(),"/data/UCI HAR Dataset", sep = "")
...
##combine data from training and test files
...
## Merge columns
alldataSubjAct<- cbind(allSubject, allActivity)
...
tidyData <- paste(getwd(),"/data/TidyData.txt", sep = "")
write.table(dataTable, tidyData, row.name=FALSE, sep = "|")
